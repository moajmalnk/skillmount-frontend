        ...
        <div className="container mx-auto px-6 max-w-7xl relative">
          ...
          <div className="flex justify-center mb-12">
            <WobbleCard className="border border-border/30 rounded-3xl overflow-hidden bg-card/30 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-700">
              <TabsList className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 h-auto bg-transparent p-2 gap-2">
                <TabsTrigger value="template-kits" className="flex flex-col items-center gap-2 py-4 px-6 rounded-2xl data-[state=active]:bg-primary data-[state=active]:text-primary-foreground transition-all duration-300 hover:bg-primary/10 group">
                  <FolderOpen className="w-5 h-5 group-hover:scale-110 transition-transform duration-300" />
                  <span className="text-xs md:text-sm font-medium">Template Kit</span>
                </TabsTrigger>
                ...
                <TabsTrigger value="docs" className="flex flex-col items-center gap-2 py-4 px-6 rounded-2xl data-[state=active]:bg-primary data-[state=active]:text-primary-foreground transition-all duration-300 hover:bg-primary/10 group">
                ...
                <TabsTrigger value="snippets" className="flex flex-col items-center gap-2 py-4 px-6 rounded-2xl data-[state=active]:bg-primary data-[state=active]:text-primary-foreground transition-all duration-300 hover:bg-primary/10 group">
                  ...
                  <span className="text-xs md:text-sm font-medium">Snippet</span>
                </TabsTrigger>
