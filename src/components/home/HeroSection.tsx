                ...
                <div className="absolute inset-0 flex items-center justify-center p-4 sm:p-6 md:p-8">
                  <div className="text-center w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto">
                    <div className="inline-flex items-center gap-2 bg-card/95 backdrop-blur-sm rounded-full px-3 py-1.5 sm:px-4 sm:py-2 mb-4 sm:mb-6 shadow-xl border border-border/50">
                      ...
                      <span className="text-xs sm:text-sm font-medium text-foreground tracking-wide">Live & Interactive</span>
                    </div>
                    <div className="bg-card/90 backdrop-blur-xl rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-2xl border border-border/40 hover:shadow-3xl transition-all duration-500">
                      <h3 className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-foreground mb-2 sm:mb-3">Ready to Transform?</h3>
                      <p className="text-xs sm:text-sm md:text-base text-muted-foreground mb-4 sm:mb-6 leading-relaxed">Join 1000+ successful students</p>
                      <Link to="/contact">
              ...
              <div className="absolute -bottom-3 sm:-bottom-4 md:-bottom-6 left-1/2 -translate-x-1/2 bg-card/95 backdrop-blur-xl border border-border/30 rounded-xl sm:rounded-2xl px-4 py-3 sm:px-6 sm:py-4 md:px-8 md:py-5 shadow-2xl hover:shadow-3xl transition-all duration-500 group">
                <a href="https://moajmalnk.in" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 sm:gap-3 hover:scale-105 transition-transform duration-300 cursor-pointer">
                  <div className="relative flex-shrink-0">
                    ...
                    <div className="absolute -top-0.5 -right-0.5 sm:-top-1 sm:-right-1 w-3 h-3 sm:w-4 sm:h-4 bg-green-500 rounded-full border-2 border-background shadow-lg"><div className="w-full h-full bg-green-400 rounded-full animate-pulse"></div></div>
                  </div>
