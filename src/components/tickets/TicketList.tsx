      ...
      {tickets.map((ticket) => (
        ...
        >
          ...
          <div className="col-span-3">
            <div className="font-semibold text-foreground truncate" title={ticket.title}>
              {ticket.title}
            </div>
          ...
          <div className="col-span-3 flex items-center gap-3">
            ...
            <div className="flex flex-col min-w-0">
              <span className="text-sm font-medium leading-none truncate">{ticket.student.name}</span>
          ...
          <div className="col-span-1 text-right">
            <Button 
              variant="ghost" 
              size="icon" 
              className="bg-muted/50 group-hover:bg-primary group-hover:text-white transition-colors h-8 w-8"
            >
