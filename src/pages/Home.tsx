...
const Home = () => {
  ...
  // 2. Logic: If logged in as Student, show Dashboard
  if (isAuthenticated && user?.role === 'student') {
    // return <StudentDashboard />;
    return <PublicLanding />;
  }

  // 3. Logic: If logged in as Tutor, maybe show Tutor Dashboard (Future)
  // For now, Tutors also see the Public Landing or we can redirect them to /tickets/manage
  
  // 4. Default: Show Public Landing Page
  return <PublicLanding />;
};
